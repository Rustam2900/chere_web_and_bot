    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=20, unique=True, validators=[users.validators.phone_number_validator], verbose_name='phone number')),
                ('password', models.CharField(blank=True, max_length=255, verbose_name='password')),
                ('reminder_days', models.PositiveIntegerField(blank=True, null=True, verbose_name='reminder days')),
                ('user_type', models.CharField(blank=True, choices=[('legal', 'Legal'), ('private', 'Private')], default='private', max_length=255, verbose_name='user type')),
